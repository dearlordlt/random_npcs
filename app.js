const npcs = new Vue({
    ...
    data: {
        ...
        weapons: [
            ...
            {name: 'sword', description: 'R1, SW 1+BBT, TR 1+BBC, W1, +1 to defence when using shield, +1 Attack with no offhand'},
            {name: 'axe', description: 'R1, SW 2+BBC, W2, +2 to shield damage, +1 Armor Piercing'},
            {name: 'mace', description: 'R1, SW 3+TTTT, W3, Stun damage to head, +2 Shock'},
